...
public class WangJiMiMaActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tianxielianxidianhua.setOnKeyListener(new View.OnKeyListener() {// 输入完后按键盘上的搜索键
					...
					public boolean onKey(View v, int keyCode, KeyEvent event) {
						if (keyCode == KeyEvent.KEYCODE_ENTER
							...
							String zhucezhanghao = tianxiezhucezhanghao
									.getText().toString();
							String lianxidianhua = tianxielianxidianhua
									.getText().toString();
	...
	private void hideKeyboard() {
		...
		InputMethodManager inputManager = (InputMethodManager) WangJiMiMaActivity.this
				.getSystemService(Context.INPUT_METHOD_SERVICE);

		inputManager.hideSoftInputFromWindow(WangJiMiMaActivity.this
