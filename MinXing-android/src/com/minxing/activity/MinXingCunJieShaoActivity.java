...
public class MinXingCunJieShaoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mWebView.setWebChromeClient(new WebChromeClient() {
			...
			public boolean onJsAlert(WebView view, String url, String message,
				...
				Builder builder = new Builder(MinXingCunJieShaoActivity.this);
			...
			public boolean onJsPrompt(WebView view, String url, String message,
				...
				final LayoutInflater factory = LayoutInflater
						.from(MinXingCunJieShaoActivity.this);
			...
			public void onProgressChanged(WebView view, int newProgress) {
				MinXingCunJieShaoActivity.this.getWindow().setFeatureInt(
			...
			public void onReceivedTitle(WebView view, String title) {
				MinXingCunJieShaoActivity.this.setTitle(title);
				super.onReceivedTitle(view, title);
			}
		});

		mWebView.loadUrl("http://baike.baidu.com/link?url=pWDU1HJfbYJRF7N_z--Wa3kpFYII7OjGeumFTeOwQToayhiQKLZcLdO1I4Qyuy8TE4sWV4cg5JHr28q3tHaHlH01jlPK_aQBDzYZz5WckdO");
	}
