...
public class SouFanShiLiuActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mWebView.setWebChromeClient(new WebChromeClient() {
			...
			public boolean onJsAlert(WebView view, String url, String message,
				...
				Builder builder = new Builder(SouFanShiLiuActivity.this);
			...
			public boolean onJsPrompt(WebView view, String url, String message,
				...
				final LayoutInflater factory = LayoutInflater
						.from(SouFanShiLiuActivity.this);
			...
			public void onProgressChanged(WebView view, int newProgress) {
				SouFanShiLiuActivity.this.getWindow().setFeatureInt(
			...
			public void onReceivedTitle(WebView view, String title) {
				SouFanShiLiuActivity.this.setTitle(title);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if ((keyCode == KeyEvent.KEYCODE_BACK) && (event.getRepeatCount() == 0)) {
			...
			SouFanShiLiuActivity.this.finish();
		}
