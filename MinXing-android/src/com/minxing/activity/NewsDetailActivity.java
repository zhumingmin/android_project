...
public class NewsDetailActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		new UMShareListener() {
			...
			public void onResult(SHARE_MEDIA platform) {
				Toast.makeText(NewsDetailActivity.this, platform + " 分享成功啦",
						Toast.LENGTH_SHORT).show();
			}

			@Override
			public void onError(SHARE_MEDIA platform, Throwable t) {
				Toast.makeText(NewsDetailActivity.this, platform + " 分享失败啦",
						Toast.LENGTH_SHORT).show();
			}

			@Override
			public void onCancel(SHARE_MEDIA platform) {
				Toast.makeText(NewsDetailActivity.this, platform + " 分享取消了",
						Toast.LENGTH_SHORT).show();
			}
		};
	...
	private void initData() {
		...
		News news = NewsActivity.newsDataList.get(position - 1);
