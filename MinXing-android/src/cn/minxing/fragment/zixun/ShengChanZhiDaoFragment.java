...
public class ShengChanZhiDaoFragment extends MyFragment {
	...
	final static String leibie = "生产指导";
	ImageView zx_tupian;
	FrameLayout fl;
	LayoutParams params;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.fragment_shengchanzhidao, container,
					false);
			isReady = true;
			delayLoad();
	...
	public void init() {
		...
		pullToRefreshListView5 = (PullToRefreshListView) v
				.findViewById(R.id.ptlv_shengchanzhidao);
		handler = new Handler() {
		...
		pullToRefreshListView5.setAdapter(zixunListViewAdapter);
		pullToRefreshListView5
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
							int position, long id) {

						Intent intent = new Intent(getActivity(),
								ShengChanZhiDaoDetailActivity.class);
