...
public class NongYeZhengCeFragment extends MyFragment {
	...
	final static String leibie = "农业政策";
	ImageView zx_tupian;
	FrameLayout fl;
	LayoutParams params;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.fragment_nongyezhengce, container,
					false);
			isReady = true;
			delayLoad();
	...
	public void init() {
		...
		pullToRefreshListView4 = (PullToRefreshListView) v
				.findViewById(R.id.ptlv_nongyezhengce);
		handler = new Handler() {
		...
		pullToRefreshListView4.setAdapter(zixunListViewAdapter);
		pullToRefreshListView4
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
							int position, long id) {
						Intent intent = new Intent(getActivity(),
								NongYeZhengCeDetailActivity.class);
