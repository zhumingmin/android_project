...
public class QiTaFragment extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.fragment_qita, container, false);
			isReady = true;
			delayLoad();
	...
	public void init() {
		...
		pullToRefreshListView6 = (PullToRefreshListView) v
				.findViewById(R.id.ptlv_qita);
		handler = new Handler() {
		...
		pullToRefreshListView6.setAdapter(zixunListViewAdapter);
		pullToRefreshListView6
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
							int position, long id) {
						Intent intent = new Intent(getActivity(),
								QiTaDetailActivity.class);
