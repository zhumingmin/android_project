...
public class NongYeXinWenFragment extends MyFragment {
	...
	final static String leibie = "农业新闻";
	ImageView zx_tupian;
	FrameLayout fl;
	LayoutParams params;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.fragment_nongyexinwen, container,
					false);
			isReady = true;
			delayLoad();
	...
	public void init() {
		...
		pullToRefreshListView3 = (PullToRefreshListView) v
				.findViewById(R.id.ptlv_nongyexinwen);
		pullToRefreshListView3.setAdapter(zixunListViewAdapter);
		pullToRefreshListView3
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
							int position, long id) {
						Intent intent = new Intent(getActivity(),
								NongYeXinWenDetailActivity.class);
