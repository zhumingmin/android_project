	...
	public void onCreate(Bundle savedInstanceState) {
		...
		chakanmoban.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(HeTongGuanLiService.this,
...
//		}
	...
	private void hideKeyboard() {
		...
		InputMethodManager inputManager = (InputMethodManager) HeTongGuanLiService.this
				.getSystemService(Context.INPUT_METHOD_SERVICE);

		inputManager.hideSoftInputFromWindow(HeTongGuanLiService.this
