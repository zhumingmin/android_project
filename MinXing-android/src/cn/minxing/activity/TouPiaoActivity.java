...
public class TouPiaoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zhumingmin.vmsofminxing.R.layout.activity_toupiao);

		mWebView = (WebView) findViewById(com.zhumingmin.vmsofminxing.R.id.WebView06);
		...
		mWebView.setWebChromeClient(new WebChromeClient() {
			...
			public boolean onJsAlert(WebView view, String url, String message,
				...
				Builder builder = new Builder(TouPiaoActivity.this);
			...
			public void onProgressChanged(WebView view, int newProgress) {
				TouPiaoActivity.this.getWindow().setFeatureInt(Window.FEATURE_PROGRESS,
						newProgress * 100);
			...
			public void onReceivedTitle(WebView view, String title) {
				TouPiaoActivity.this.setTitle(title);
...
//			intent.setClass(TouPiao.this, SheZhi.class);
