...
public class CategoryTabStrip extends HorizontalScrollView {
	...
	private void addTab(final int position, String title) {
		...
		TextView category_text = (TextView) tab.findViewById(R.id.cate_text);
	...
	private void calculateIndicatorRect(Rect rect) {
		...
		category_text = (TextView) currentTab.findViewById(R.id.cate_text);// 空指针异常
	...
	public void draw(Canvas canvas) {
		...
		calculateIndicatorRect(indicatorRect);// 空指针异常
